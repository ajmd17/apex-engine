...
class MglEngine : public CoreEngine {
public:
    ...
    void BindFragDataLocation(unsigned int program, unsigned int color_number, const char *name);
    ...
    void CopyTexSubImage2D(unsigned int target, int level, int xoffset, int yoffset, int x, int y, int width, int height);
